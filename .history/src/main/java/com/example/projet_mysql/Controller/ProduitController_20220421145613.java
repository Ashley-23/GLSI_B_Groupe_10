...
public class ProduitController {
    ...
    public String modifierProduit(@PathVariable("id") int id, Model model)
    {
        model.addAttribute("oneProduit", produitService.oneproduit(id));
        model.addAttribute("oneCategorie",categorieService.oneCategorie(id))
        return "/produit/edit";
    }
